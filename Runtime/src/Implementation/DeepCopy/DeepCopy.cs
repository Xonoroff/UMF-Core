...
namespace UMF.Core.Implementation
{
    ...
    {
        /// <summary>
        /// Global provider for obtaining an <see cref="IDeepCloneSerializer"/> used by the parameterless <see cref="DeepClone{T}(T)"/>.
        ...
        /// </summary>
        private static IDeepCloneSerializerProvider SerializerProvider { get; set; } = new DeepCopySerializerProvider();
        ...
        public static T DeepClone<T>(this T obj)
        {
            ...
            var provider = SerializerProvider ?? throw new InvalidOperationException("DeepCopy.SerializerProvider is not set.");
            var serializer = provider.GetSerializer<T>() ?? throw new InvalidOperationException("SerializerProvider returned null serializer.");
